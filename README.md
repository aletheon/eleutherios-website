...
- Creates new capacity (Service providers can scale a forum or network)
...
The <i><b>customer request</b></i> or network is linear or one-to-one relationship with each service provider.
