...
@Component({
  selector: 'user-service-review-view',
  templateUrl: './user.service.review.view.component.html',
  styleUrls: ['./user.service.review.view.component.css']
})
export class UserServiceReviewViewComponent implements OnInit, OnDestroy  {
                      ...
                      return that.userServiceService.getService(serviceReview.serviceUid, serviceReview.serviceId).pipe(
                        switchMap(service => {
                          if (service){
                            ...
                            return combineLatest([getDefaultServiceImage$, getServiceRate$]).pipe(
                              switchMap(results => {
                                const [defaultServiceImage, serviceRates] = results;
