...
exports.createPaymentIntent = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const newPayment = {
      ...
      buyerType: buyerService.type,
      buyerPaymentType: buyerService.paymentType,
      buyerTitle: buyerService.title,
      buyerDescription: buyerService.description,
      sellerType: sellerService.type,
      sellerPaymentType: sellerService.paymentType,
      sellerTitle: sellerService.title,
      sellerDescription: sellerService.description,
      quantity: 1,
      status: '',
      buyerUid: buyerUid,
